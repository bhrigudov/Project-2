...
/**
 * Servlet implementation class Tab2_4_1
 */
@WebServlet("/Tab2_4_1")
public class Tab2_4_1 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(!f.exists()){
	    	...
	    	bw.println("Taken GATE Exam?	" + ques);
		...
		if(ques.equals("yes"))
		{
			String site = new String("/Applicant/Tab2_4_2.html");
