...
/**
 * Servlet implementation class Tab2_2_1
 */
@WebServlet("/Tab2_2_1")
public class Tab2_2_1 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(!f.exists()){
	    	...
	    	bw.println("Have you completed your Post Graduation?	" + ques);
		...
		if(ques.equals("yes"))
		{
			String site = new String("/Applicant/Tab2_2_2.html");
		...
		else if(ques.equals("no"))
		{
	    	...
	    	bw2.print(degree + "," + department + "," + college + "," + thesis + "," + city + "," + state + "," + yopg + "," + marks + ",");                         
	        bw2.close();
