...
/**
 * Servlet implementation class Tab2_3_1
 */
@WebServlet("/Tab2_3_1")
public class Tab2_3_1 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(!f.exists()){
	    	...
	    	bw.println("Other Academic Degrees?	" + ques);
		...
		if(ques.equals("yes"))
		{
			String site = new String("/Applicant/Tab2_3_2.html");
